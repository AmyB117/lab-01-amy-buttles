...
There are 1846 rows with 3 variables.
...
ggplot(data = dino_data, mapping = aes(x = 55.4, y = 97.2)) +
  geom_point()
```
...
dino **r** is = -0.06447185 and star **r** is = -0.0629611
...
dino **r** is = -0.06447185 and circle **r** is = -0.06834336
